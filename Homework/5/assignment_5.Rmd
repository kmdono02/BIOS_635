...
- Within the training step, choose the tuning parameter based on the minimum MSE on the training set.  Try 20 different tuning parameters to evaluate (`tuneLength=20`) and print the MSEs for each of these examined parameters
...
- First, choose the best tuning parameter for the KNN algorithm by trying 20 different tuning parameters to evaluate (`tuneLength=20`) and print the MSEs for each of these examined parameters, **in the entire dataset**
