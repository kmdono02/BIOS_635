...
- For the data from years 2000, 2005, and 2010, train a single linear regression model to predict `Life expectancy` solely based on `Country` as the only predictor.  Then to test, predict the 2015 life expectancy for the countries in the data.  Print out the MSE, MAE, and $R^2$ on the testing set for this model.
